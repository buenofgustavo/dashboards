...
resultado_graf2 = resultado_graf2.sort_values(by='frequencia', ascending=False).head(5)
...
while(i<len(tomadores_graf3)):
    ...
    PCs_cancelado_cliente_graf3.append(tab_tomador_graf3[tab_tomador_graf3['STATUS'] == 'CANCELADO - CLIENTE'].shape[0])
    PCs_declinada_atendimento_graf3.append(tab_tomador_graf3[tab_tomador_graf3['STATUS'] == 'DECLINADO - FALTA ATENDIMENTO'].shape[0])
    PCs_declinadas_graf3.append(PCs_carga_recusada_graf3[i] + PCs_cancelado_cliente_graf3[i] + PCs_declinada_atendimento_graf3[i])
    i+=1
...
############################################################ Dropdown 1 #################################################################
    ...
    dbc.Row([
        dbc.Col([
            html.Label('Escolha a linha:', style={"font-weight": "bold"}),
            dbc.Select(
                id='lista_linhas',
        ...
        dbc.Col([
            html.Label('Escolha o Cliente:', style={"font-weight": "bold"}),
            dbc.Select(
                id="select_clientes",
        ...
        dbc.Col([
            html.Label('Escolha a Filial:', style={"font-weight": "bold"}),
            dbc.Select(
                id="select_fil",
        ...
        dbc.Col([
            html.Label('Escolha o Ponto Inicial:', style={"font-weight": "bold"}),
            dbc.Select(
                id="select_ponto_ini",
                value='TODOS',
        ...
        dbc.Col([
            html.Label('Escolha o Ponto Final:', style={"font-weight": "bold"}),
            dbc.Select(
                id="select_ponto_fim",
                value='TODOS',
    ...
    dbc.Row([
        dbc.Col(
            dbc.Card(
                ...
                children=[
                    dbc.CardHeader("Potencial Perdido", style={"font-size": "0.9rem", "font-weight": "bold"}),
                    dbc.CardBody([
                        html.H4(f'R$ {faturamento_potencial_perdido_card1}', className="card-title", style={"font-size": "0.9rem", "font-weight": "bold"}),
                    ]),
                ],
        ...
        dbc.Col(
            dbc.Card(
                id='card_canceladas_cliente',
                children=[
                    dbc.CardHeader("Cargas Canceladas Cliente", style={"font-size": "0.9rem", "font-weight": "bold"}),
                    dbc.CardBody([
                        html.H4(f'{PCs_declinadas_cliente_card2}', className="card-title", style={"font-size": "0.9rem", "font-weight": "bold"}),
                    ]),
                ],
                className="text-white",
...
dbc.Row([
    ...
    dbc.Col(
        dcc.Graph(
            id='grafico_situac',
            figure=fig,
            style={'width': '100%', 'height': '80vh', 'margin': '60px auto 0px auto'}  # Centered horizontally
        ),
    ...
    dbc.Col(
        dcc.Graph(
            id='grafico_fat_cli',
            figure=fig2,
            style={'width': '100%', 'height': '80vh', 'margin': '60px auto 0px auto'}  # Centered horizontally, same top margin
        ),
    ),
], style={'margin': 'auto'}),  # Margem superior para separar os gráficos
...
# Card 2
@app.callback(
    Output('card_canceladas_cliente', 'children'),
    [
        Input('lista_linhas', 'value'),
        Input('select_clientes', 'value'),
        Input('select_fil', 'value'),
